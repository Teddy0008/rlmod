package com.teddy0007.rlmod.client.screen;
...
public class CrusherScreen extends ContainerScreen<CrusherContainer> {
	...
	private static final ResourceLocation CRUSHER_GUI = new ResourceLocation(Main.MOD_ID, "textures/gui/crusher.png");
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX,
		...
		this.minecraft.textureManager.bindTexture(CRUSHER_GUI);
